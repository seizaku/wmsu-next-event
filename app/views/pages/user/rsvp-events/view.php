<div class="drawer lg:drawer-open">
  ...
  <div class="drawer-content bg-base-100">
    ...
    <section class="w-full p-12">
      <p class="text-3xl font-bold">RSVP'd Events</p>
      <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-8 mt-4">


        <div class="w-full h-28 bg-base-100 border rounded-lg p-4 shadow">
          <div class="flex items-center justify-between">
            <h1 class="text-sm font-medium">Total Events</h1>
        ...
        <div class="w-full h-28 bg-base-100 border rounded-lg p-4 shadow">
          <div class="flex items-center justify-between">
            <h1 class="text-sm font-medium">Attended Events</h1>
        ...
        <div class="w-full h-28 bg-base-100 border rounded-lg p-4 shadow">
          <div class="flex items-center justify-between">
            <h1 class="text-sm font-medium">Certificates Earned</h1>
        ...
        <div class="w-full h-28 bg-base-100 border rounded-lg p-4 shadow">
          <div class="flex items-center justify-between">
            <h1 class="text-sm font-medium">Engagement Score</h1>
            <i data-lucide="zap" class="h-4 w-4 text-neutral"></i>
          </div>
          <h1 class="mt-1 text-2xl font-bold">12</h1>
          <p class="text-sm ">+2 from last month</p>
        </div>
